...
var miolayer = map.getLayer('point');
    ...
    map.fire('click', { lngLat: ll, point:pointsel })
      ...
      map.addLayer({
        ...
        "source": {
            "type": "vector",
            "tiles": ["https://geospatial.jrc.ec.europa.eu/geoserver/gwc/service/wmts?layer=dopa_analyst:drc_bound&tilematrixset=EPSG:900913&Service=WMTS&Request=GetTile&Version=1.0.0&Format=application/x-protobuf;type=mapbox-vector&TileMatrix=EPSG:900913:{z}&TileCol={x}&TileRow={y}"]
            },
        "source-layer": "drc_bound",
 ...
 map.addLayer({
  ...
  ['!in', 'adm0_code', 68]
    ...
    var features = map.queryRenderedFeatures({ layers: ["drc_bound"] });
...
setTimeout(function(){
  ...
  map.on('click', 'drc_bound', function(e) {
    ...
    function toggle(button)
{
  if(document.getElementById("1").value=="OFF"){
   ...
   document.getElementById("1").value="OFF";}
      ...
      var cfeatures = map.queryRenderedFeatures(e.point, { layers: ['drc_bound'] });
      var filter = cfeatures.reduce(function(memo, feature) {
         ...
         map.setFilter("drc_bound", filter);
  ...
  $('input.checkbox_check').change(function(){
      ...
      var filter_points_2 = ['all',["!in", "pca", 1]];
      ...
      map.setFilter('grid_points_3', "!in", 'adm0_code', 0);
      setTimeout(function(){
      $("#submit").click();
